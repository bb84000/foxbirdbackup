...
!define prog_name "Foxbirdbackup"
...
LangString RemoveStr ${LANG_ENGLISH}  "FoxBird Backup"
LangString RemoveStr ${LANG_FRENCH} "Sauvegarde FoxBird"

;Language string for links
LangString ProgramLnkStr ${LANG_ENGLISH} "FoxBird Backup.lnk"
LangString ProgramLnkStr ${LANG_FRENCH} "Sauvegarde FoxBird.lnk"
...
LangString ProgramDescStr ${LANG_ENGLISH} "Firefox & Thunderbird backup"
LangString ProgramDescStr ${LANG_FRENCH} "Sauvegarde de Firefox & Thunderbird"
LangString ShortcutDescStr ${LANG_ENGLISH} "Firefox and Thunderbird profiles backup"
LangString ShortcutDescStr ${LANG_FRENCH} "Sauvegarde des profils de Firefox et Thunderbird"
;--------------------------------------------------------
...
Section "Dummy Section" SecDummy
  ...
  ; Remove old shortcuts directory
  RMDir /r "$SMPROGRAMS\foxbirdbackup"
...
Function ChkVerPage
  ...
  ${else}
    ...
    ${If} ${RunningX64}
      ReadRegStr $old_uninstpath HKLM "SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Foxbirdbackup" "UninstallString"
      ${if} $old_uninstpath != ""
